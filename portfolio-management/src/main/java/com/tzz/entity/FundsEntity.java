...
@Entity
@Table(name = "funds", schema = "financial_system", catalog = "")
public class FundsEntity {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && Objects.equals(name, that.name) && Objects.equals(fundCode, that.fundCode) && Objects.equals(date, that.date) && Objects.equals(open, that.open) && Objects.equals(high, that.high) && Objects.equals(low, that.low) && Objects.equals(close, that.close) && Objects.equals(adjClose, that.adjClose) && Objects.equals(volume, that.volume) && Objects.equals(rol, that.rol);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, fundCode, date, open, high, low, close, adjClose, volume, rol, id);
    }
}
